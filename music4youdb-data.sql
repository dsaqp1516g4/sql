...
insert into ads (id, userid, subject, description, precio, type, image) values (UNHEX('1'), UNHEX('1'),'Orquesta Cimarrón', 'Dues presses de corrent trifàsica a peu de l escenari, una per a l equip so: Line Array Electro-Voice  de 26.000 W i l altre per a la il·luminació de 45.000 W', '100.0', '1', NULL);
...
insert into comments (id, userid, eventid, anuncioid, content) values (UNHEX('1'), UNHEX('1'), NULL, UNHEX('1'), 'es muy bueno');
>>>>>>> c9f22d0a17956e95f080365658dda084bb741856
